      ...
      <div role="listitem" class="freebirdFormviewerViewItemsItemItem" jsname="ibnC6b" jscontroller="hIYTQc" jsaction="JIbuQc:qzJD1c;sPvj8e:e4JwSe" data-required="true" data-other-input="qSV85" data-other-hidden="MfYA1e" data-item-id="131124881">
         ...
         <div class="freebirdFormviewerViewItemsItemItemheader">
            ...
            <div class="freebirdFormviewerViewItemsItemItemTitleContainer">
               ...
               <div class="freebirdFormviewerViewItemsItemItemHelpText" id="i.desc.131124881" dir="auto" align="justify" style="color: #FBF8EF;font-size: 16px; font-family: calibri">Manifiestamos que decidimos participar voluntariamente en el evento 24 HORAS DE CICLO MONTAÑISMO, mediante el uso de bicicletas Todo Terreno, haciéndolo bajo nuestra entera responsabilidad, manifestando que nos encuentramos en perfecto estado físico y de salud. Adicionalmente DECLARAMOS que recibimos las recomendaciones necesarias y que aceptaremos cualquier decisión de la organización y del Instituto Distrital de Recreación y Deporte – IDRD, sobre nuestra participación. <br>

               Asumimos todos los riesgos asociados con nuestro recorrido, incluidos pero no limitados, a caídas y demás accidentes, enfermedades generales, enfermedades de tipo cardíaco, por el contacto con otras personas o elementos, las condiciones climáticas incluida temperatura, lluvia y humedad, estado de las vías, y en general cualquier tipo de riesgos que declaramos conocidos y valorados por nosotros. Así mismo declaramos que conocemos la información general. <br>

               Manifiestamos que liberamos a los organizadores, al Instituto Distrital de Recreación y Deporte – IDRD, Alcaldía Mayor de Bogotá, aliados, patrocinadores, representantes y sucesores, de todo reclamo o responsabilidad de cualquier tipo que surja por nuestra participación en el recorrido, aunque esta responsabilidad pueda surgir por negligencia o culpa de la organización; así como de cualquier extravío, robo y/o hurto. <br>

               Por último, autorizamos a los organizadores a iniciar las acciones que consideren pertinentes, en caso de que por nuestra participación genere un hecho que pueda afectar los intereses del Instituto Distrital de Recreación y Deporte – IDRD. Igualmente, autorizamos al IDRD para que haga uso de las fotografías, películas, videos, grabaciones y cualquier otro medio de registro de este programa para su uso legítimo, sin reclamación o compensación económica alguna.<br>
